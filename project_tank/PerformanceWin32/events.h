...
public:
    ...
    // Event system
    virtual bool	Setup( HWND _hwnd, float depth, 
						   int widht, int height, TString& errStr );
...
private:
	...
	bool DXSetup( HWND hWnd, bool fullScreen, int width, int height, 
				  int depth, TString& errStr );
